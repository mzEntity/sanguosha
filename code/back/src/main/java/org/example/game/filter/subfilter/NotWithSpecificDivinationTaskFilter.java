 ...
 * @Date: 2024/8/24
 */
public class NotWithSpecificDivinationTaskFilter implements TargetFilter {
    private final DelayedSkillType delayedSkillType;
    public NotWithSpecificDivinationTaskFilter(DelayedSkillType delayedSkillType) {
